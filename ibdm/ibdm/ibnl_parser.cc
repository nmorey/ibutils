...
{
       0,   247,   247,   248,   250,   251,   253,   255,   256,   259,
     260,   264,   265,   270,   274,   275,   274,   281,   282,   281,
     286,   287,   291,   294,   295,   296,   300,   304,   307,   308,
     312,   313,   317,   320,   323,   326,   332,   335,   338,   341,
     347,   348,   352,   355,   356,   360,   363,   364,   368,   369,
     373,   376,   379,   382,   388,   391,   394,   397
};
#endif
...
#line 264 "ibnl_parser.yy"
    { ibnlMakeSubInstAttribute((yyvsp[(1) - (5)].sval),(yyvsp[(3) - (5)].sval),(yyvsp[(5) - (5)].sval)); }
    break;
...
#line 265 "ibnl_parser.yy"
    {
      char buf[16];
      sprintf(buf, "%d", (yyvsp[(5) - (5)].ival));
      ibnlMakeSubInstAttribute((yyvsp[(1) - (5)].sval),(yyvsp[(3) - (5)].sval),buf);
   }
    break;

  case 13:
#line 270 "ibnl_parser.yy"
    {ibnlMakeSubInstAttribute((yyvsp[(1) - (3)].sval),(yyvsp[(3) - (3)].sval),NULL); }
    break;
...
#line 291 "ibnl_parser.yy"
    { gSysNames.push_back((yyvsp[(1) - (1)].sval)); }
    break;

  case 27:
#line 304 "ibnl_parser.yy"
    { ibnlMakeNode((yyvsp[(2) - (5)].tval),(yyvsp[(3) - (5)].ival),(yyvsp[(4) - (5)].sval),(yyvsp[(5) - (5)].sval)); }
    break;

  case 32:
#line 317 "ibnl_parser.yy"
    {
      ibnlMakeNodeToNodeConn((yyvsp[(1) - (9)].ival), (yyvsp[(3) - (9)].sval), (yyvsp[(5) - (9)].sval), (yyvsp[(8) - (9)].sval), (yyvsp[(9) - (9)].ival));
    }
    break;
...
#line 320 "ibnl_parser.yy"
    {
      ibnlMakeNodeToNodeConn((yyvsp[(1) - (7)].ival), (yyvsp[(3) - (7)].sval), "2.5", (yyvsp[(6) - (7)].sval), (yyvsp[(7) - (7)].ival));
    }
    break;
...
#line 323 "ibnl_parser.yy"
    {
      ibnlMakeNodeToNodeConn((yyvsp[(1) - (7)].ival), "4x", (yyvsp[(3) - (7)].sval), (yyvsp[(6) - (7)].sval), (yyvsp[(7) - (7)].ival));
    }
    break;
...
#line 326 "ibnl_parser.yy"
    {
      ibnlMakeNodeToNodeConn((yyvsp[(1) - (5)].ival), "4x", "2.5", (yyvsp[(4) - (5)].sval), (yyvsp[(5) - (5)].ival));
    }
    break;
...
#line 332 "ibnl_parser.yy"
    {
      ibnlMakeNodeToPortConn((yyvsp[(1) - (8)].ival), (yyvsp[(3) - (8)].sval), (yyvsp[(5) - (8)].sval), (yyvsp[(8) - (8)].sval));
    }
    break;
...
#line 335 "ibnl_parser.yy"
    {
      ibnlMakeNodeToPortConn((yyvsp[(1) - (6)].ival), (yyvsp[(3) - (6)].sval), "2.5", (yyvsp[(6) - (6)].sval));
    }
    break;
...
#line 338 "ibnl_parser.yy"
    {
      ibnlMakeNodeToPortConn((yyvsp[(1) - (6)].ival), "4x", (yyvsp[(3) - (6)].sval), (yyvsp[(6) - (6)].sval));
    }
    break;
...
#line 341 "ibnl_parser.yy"
    {
      ibnlMakeNodeToPortConn((yyvsp[(1) - (4)].ival), "4x", "2.5", (yyvsp[(4) - (4)].sval));
    }
    break;

  case 42:
#line 352 "ibnl_parser.yy"
    { ibnlMakeSubsystem((yyvsp[(2) - (3)].sval),(yyvsp[(3) - (3)].sval)); }
    break;

  case 45:
#line 360 "ibnl_parser.yy"
    { ibnlRecordModification((yyvsp[(1) - (3)].sval),(yyvsp[(3) - (3)].sval)); }
    break;

  case 50:
#line 373 "ibnl_parser.yy"
    {
      ibnlMakeSubsystemToSubsystemConn((yyvsp[(1) - (9)].sval), (yyvsp[(3) - (9)].sval), (yyvsp[(5) - (9)].sval), (yyvsp[(8) - (9)].sval), (yyvsp[(9) - (9)].sval));
    }
    break;
...
#line 376 "ibnl_parser.yy"
    {
      ibnlMakeSubsystemToSubsystemConn((yyvsp[(1) - (7)].sval), (yyvsp[(3) - (7)].sval), "2.5", (yyvsp[(6) - (7)].sval), (yyvsp[(7) - (7)].sval));
    }
    break;
...
#line 379 "ibnl_parser.yy"
    {
      ibnlMakeSubsystemToSubsystemConn((yyvsp[(1) - (7)].sval), "4x", (yyvsp[(3) - (7)].sval), (yyvsp[(6) - (7)].sval), (yyvsp[(7) - (7)].sval));
    }
    break;
...
#line 382 "ibnl_parser.yy"
    {
      ibnlMakeSubsystemToSubsystemConn((yyvsp[(1) - (5)].sval), "4x", "2.5", (yyvsp[(4) - (5)].sval), (yyvsp[(5) - (5)].sval));
    }
    break;
...
#line 388 "ibnl_parser.yy"
    {
      ibnlMakeSubsystemToPortConn((yyvsp[(1) - (8)].sval), (yyvsp[(3) - (8)].sval), (yyvsp[(5) - (8)].sval), (yyvsp[(8) - (8)].sval));
    }
    break;
...
#line 391 "ibnl_parser.yy"
    {
      ibnlMakeSubsystemToPortConn((yyvsp[(1) - (6)].sval), (yyvsp[(3) - (6)].sval), "2.5", (yyvsp[(6) - (6)].sval));
    }
    break;
...
#line 394 "ibnl_parser.yy"
    {
      ibnlMakeSubsystemToPortConn((yyvsp[(1) - (6)].sval), "4x", (yyvsp[(3) - (6)].sval), (yyvsp[(6) - (6)].sval));
    }
    break;
...
#line 397 "ibnl_parser.yy"
    {
      ibnlMakeSubsystemToPortConn((yyvsp[(1) - (4)].sval), "4x", "2.5", (yyvsp[(4) - (4)].sval));
    }
    break;


/* Line 1267 of yacc.c.  */
#line 1784 "ibnl_parser.cc"
      default: break;
    }
